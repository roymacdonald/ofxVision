...
namespace ofxVision{
//--------------------------------------------------------------------------------------------------------
    RectDetection::RectDetection(const ofRectangle& _rect, float confidence ):rect(_rect), score(confidence){
    }
    RectDetection::RectDetection(float x, float y, float w, float h, float confidence ):rect(x, y, w, h), score(confidence){
    }
    ...
    void RectDetection::drawLabel(bool bDrawScore ){
        std::string txt;
        if(!label.empty()){
            txt += label;
            if(bDrawScore){
